...
public class TPCH1Benchmark extends AbstractTPCHBenchmark {
	...
	public void execute() {
		...
		try {
			...
			DataSource<Tuple7<Float, Float, Float, Float, Character, Character, String>> lineItems = reader
					.types(Float.class, Float.class, Float.class, Float.class,
							Character.class, Character.class, String.class);

			// Filter on date.
			DataSet<Tuple7<Float, Float, Float, Float, Character, Character, String>> filteredLineItems = lineItems
					.filter(new FilterFunction<Tuple7<Float, Float, Float, Float, Character, Character, String>>() {

						private static final long serialVersionUID = -818134663949093125L;

						@Override
						public boolean filter(
								Tuple7<Float, Float, Float, Float, Character, Character, String> tuple)
								throws Exception {
			...
			DataSet<Tuple9<Character, Character, Float, Float, Float, Float, Float, Float, Float>> mappedLineItems = filteredLineItems
					.map(new MapFunction<Tuple7<Float, Float, Float, Float, Character, Character, String>, Tuple9<Character, Character, Float, Float, Float, Float, Float, Float, Float>>() {

						private static final long serialVersionUID = 8021849053433646399L;

						@Override
						public Tuple9<Character, Character, Float, Float, Float, Float, Float, Float, Float> map(
								Tuple7<Float, Float, Float, Float, Character, Character, String> tuple)
								throws Exception {
							float discountedPrice = tuple.f1
									* (1.0f - tuple.f2);
							return new Tuple9<Character, Character, Float, Float, Float, Float, Float, Float, Float>(
			...
			DataSet<Tuple9<Character, Character, Float, Float, Float, Float, Float, Float, Float>> result = mappedLineItems
			...
			result.map(new MapFunction<Tuple9<Character, Character, Float, Float, Float, Float, Float, Float, Float>, Tuple9<Character, Character, Float, Float, Float, Float, Float, Float, Float>>() {

				private static final long serialVersionUID = -6596407623350163628L;

				@Override
				public Tuple9<Character, Character, Float, Float, Float, Float, Float, Float, Float> map(
						Tuple9<Character, Character, Float, Float, Float, Float, Float, Float, Float> tuple)
						throws Exception {
					tuple.f6 /= count;
					tuple.f7 /= count;
					tuple.f8 /= count;
